...
const I18N = {
  en: {
    ...
    partyTimelinePremiumOnly: 'Party Compare is a Supporter-only feature.',
    ...
    phaseAll: 'All Phases',
    usageLimitReached: 'Daily comparison limit reached. Supporters have unlimited comparisons.',
  ...
  ja: {
    ...
    partyTimelinePremiumOnly: 'PT比較はサポーター専用の機能です。',
    ...
    usageLimitReached: '1日の比較上限に達しました。サポーターなら無制限です。',
