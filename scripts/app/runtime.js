...
const SELF_BUFFS = [
  ...
  { nameEn: 'Manafication',     nameJa: 'マナフィケーション',     duration: 30, color: '#6366f1' },
...
const I18N = {
  en: {
    ...
    siteDesc: 'Compare skill rotations from 2 public FF Logs URLs',
    step1Title: '1. Load Public FF Logs Logs',
    publicOnlyNote: 'Public FF Logs logs only. No FF Logs sign-in is required.',
    logUrlA: 'Log URL A',
    logUrlB: 'Log URL B',
    loadBtn: 'Load Reports',
    loadResetBtn: 'Reset',
    step2Title: '2. Select Fight Data (Kill only)',
    step2HelpText: 'Choose the fight to compare from each report.',
    ...
    step3HelpText: 'Choose the players you want to compare by job and role.',
    logAPlayer: 'Log A Player',
    logBPlayer: 'Log B Player',
    compareBtn: 'Start Comparison',
    step4Title: '4. Comparison Results',
    personalTimelineView: 'Player Compare',
    partyTimelineView: 'Party Compare',
    tabAll: 'Full TL',
    tabOdd: 'Odd Min TL',
    tabEven: 'Even Min TL',
    laneAbility: 'Ability',
    ...
    layerDebuff: 'Weakness / Damage Down',
    layerCast: 'Boss Casts',
    supporterOnlySuffix: 'Supporter only',
    ...
    logoutBtn: 'Log out',
    usageRemaining: (remaining) => `Remaining today: ${remaining >= 9999 ? 'Expanded' : remaining}`,
    statusLabel: 'Status:',
    statusFree: 'Free',
    ...
    navHome: 'Home',
    navGuide: 'First time here?',
    navLang: 'Language',
    navRequest: 'Feedback / Request',
    navRanking: 'Ranking',
    navRankingDamage: 'Damage Rankings',
    navRankingSpeed: 'Speed Rankings',
    sidebarDataSourceLabel: 'Username',
    sidebarMemberStatusLabel: 'Membership Status',
    sidebarRemainingLabel: 'Remaining Today',
    ...
    bookmarkNamePrompt: 'Bookmark name (leave blank for automatic name)',
    bookmarkRenamePrompt: 'New bookmark name',
    bookmarkEdit: 'Edit name',
    bookmarkRenameFailed: 'Failed to update bookmark name.',
    ...
    tutorialLoadReportsBody: 'Paste one FF Logs report URL into A and one into B, then load the reports. When the fight selectors appear, this step is complete.',
    ...
    badUrl: 'Please check FF Logs URL format.',
    loading: 'Loading reports...',
    killFightsLoaded: (a,b) => `Kill fights loaded: A=${a} / B=${b}`,
    playersLoaded: (a,b) => `Players loaded: A=${a} / B=${b}`,
    playersNeedReload: 'Fight changed. Reload the player list for the selected fight.',
    tlLoading: 'Loading player timeline...',
    tlLoaded: (a,b) => `TL loaded: A=${a} / B=${b}`,
    partyTlLoading: 'Loading party timelines...',
    partyTlLoaded: (a,b) => `Party TL loaded: A=${a} players / B=${b} players`,
    partyTlLoadFailed: (message) => `Party timeline failed: ${message}`,
    partyTimelinePremiumOnly: 'Party Compare is available to free users.',
    compareFailed: (message) => `Comparison failed: ${message}`,
    timelineRenderFailed: (message) => `Timeline render failed: ${message}`,
    kill: 'Kill',
    wipe: 'Wipe',
    encounterMismatch: 'The selected fights appear to be different encounters. Choose the same boss on both sides, then load players again. Retrying with the current selection will not work.',
    phaseAll: 'All Phases',
    usageLimitReached: 'Daily comparison limit reached. Supporters receive expanded comparison limits.',
    usageCheckFailed: 'Failed to check usage. Please try again later.',
  },
  ja: {
    siteTitle: 'XIV Skill Rotation Diff',
    siteDesc: 'FF Logs の公開ログ URL 2 件からスキル回しを比較します',
    step1Title: '1. 公開 FF Logs ログを読み込む',
    logUrlA: 'ログURL A',
    logUrlB: 'ログURL B',
    loadBtn: '読み込み開始',
    step2Title: '2. 戦闘データ選択（Kill のみ）',
    step2HelpText: '各レポートから比較する戦闘を選択してください。',
    logAFight: 'ログA 戦闘',
    logBFight: 'ログB 戦闘',
    loadPlayersBtn: 'この戦闘でプレイヤー一覧を取得',
    step3Title: '3. 比較するプレイヤー選択',
    step3HelpText: '比較したいプレイヤー（ジョブ・ロール）を選択してください。',
    logAPlayer: 'ログAプレイヤー',
    logBPlayer: 'ログBプレイヤー',
    compareBtn: '比較を開始',
    step4Title: '4. 比較結果',
    personalTimelineView: '個人比較',
    partyTimelineView: 'PT比較',
    tabAll: '全体TL',
    tabOdd: '奇数分TL',
    tabEven: '偶数分TL',
    laneAbility: 'アビリティ',
    ...
    laneSynergy: 'シナジー',
    layerSynergy: 'シナジー',
    layerDebuff: '衰弱・与ダメ低下',
    layerCast: 'ボス詠唱',
    supporterOnlySuffix: 'サポーター限定',
    debugNormalTitle: 'ログ',
    debugErrorTitle: 'エラーログ',
    publicOnlyNote: '公開ログのみ対応です。',
    badUrl: 'FF Logs URL形式を確認してください。',
    loading: 'レポートを読み込み中...',
    killFightsLoaded: (a,b) => `Kill戦闘一覧取得成功: A=${a}件 / B=${b}件`,
    playersLoaded: (a,b) => `プレイヤー取得成功: A=${a}人 / B=${b}人`,
    playersNeedReload: '戦闘が変更されました。この戦闘でプレイヤー一覧を再取得してください。',
    tlLoading: '選択プレイヤーのTLを取得中...',
    tlLoaded: (a,b) => `TL取得成功: A=${a}件 / B=${b}件`,
    partyTlLoading: 'PT比較TLを取得中...',
    partyTlLoaded: (a,b) => `PT比較TL取得成功: A=${a}人 / B=${b}人`,
    partyTlLoadFailed: (message) => `PT比較TLの取得に失敗しました: ${message}`,
    partyTimelinePremiumOnly: 'PT比較は無料ユーザーでも利用できます。',
    compareFailed: (message) => `比較に失敗しました: ${message}`,
    timelineRenderFailed: (message) => `タイムライン描画に失敗しました: ${message}`,
    kill: 'Kill',
    wipe: 'Wipe',
    encounterMismatch: '選択された戦闘が別のボスのようです。左右で同じボスを選び直し、プレイヤー一覧を再取得してください。この選択のまま再試行しても比較できません。',
    phaseAll: '全フェーズ',
    tutorialBtn: '初めての方はこちら',
    contactBtn: 'ご要望フォーム',
    authLoginSignup: 'ログイン / 会員登録',
    logoutBtn: 'ログアウト',
    usageRemaining: (remaining) => `本日残り回数：${remaining >= 9999 ? '上限拡張中' : remaining}`,
    statusLabel: 'ステータス：',
    statusFree: '無料版',
    statusRegister: '登録',
    statusSupporter: 'サポーター',
    statusFreeLabel: '無料会員',
    guestLabel: 'ゲスト',
    authLoginLabel: 'ログイン',
    navHome: 'ホーム',
    navGuide: '初めての方はこちら',
    ...
    navRequest: 'ご要望フォーム',
    navRanking: 'ランキング',
    navRankingDamage: 'ダメージランキング',
    navRankingSpeed: 'スピードランキング',
    sidebarDataSourceLabel: 'ユーザー名',
    sidebarMemberStatusLabel: '会員ステータス',
    sidebarRemainingLabel: '本日の残り回数',
    ...
    bookmarkRenamed: 'ブックマーク名を変更しました。',
    bookmarkPremiumOnly: 'ブックマークはサポーター専用の機能です。',
    bookmarkSavedAt: '保存日時：',
    bookmarkContent: 'コンテンツ：',
    bookmarkNamePrompt: 'ブックマーク名（空欄なら自動名）',
    bookmarkRenamePrompt: '新しいブックマーク名',
    bookmarkEdit: '名前編集',
    bookmarkRenameFailed: 'ブックマーク名の変更に失敗しました。',
    ...
    usageLimitReached: '1日の比較上限に達しました。サポーターでは比較上限が拡張されます。',
...
const state = {
  ...
  selectedB: null,
  isPremium: false,
  showSynergyTimeline: true,
  showDebuffTimeline: true,
  showCastTimeline: true,
  currentTab: 'all',
  timelineView: 'personal',
  timelineA: [],
  timelineB: [],
  timelineCountA: 0,
  timelineCountB: 0,
...
const el = {
  ...
  loadResetBtn: document.getElementById('loadResetBtn'),
  ...
  timelineViewBtns: [...document.querySelectorAll('[data-timeline-view]')],
  personalTimelineViewBtn: document.getElementById('personalTimelineViewBtn'),
  partyTimelineViewBtn: document.getElementById('partyTimelineViewBtn'),
  timelineWrap: document.getElementById('timelineWrap'),
  zoomInBtn: document.getElementById('zoomInBtn'),
  zoomOutBtn: document.getElementById('zoomOutBtn'),
  zoomLabel: document.getElementById('zoomLabel'),
  timelineLayerToggles: [...document.querySelectorAll('[data-timeline-layer]')],
  ...
  step2HelpText: document.getElementById('step2HelpText'),
  step3Title: document.getElementById('step3Title'),
  step3HelpText: document.getElementById('step3HelpText'),
